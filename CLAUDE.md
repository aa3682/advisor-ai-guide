...
- Advisor-specific platform [#advisor-specific-platform] — linked from content/introduction/index.mdx, content/process/decide-what-ai-is-for/index.mdx, content/process/sort-your-data/index.mdx, content/process/vet-and-choose-tools/index.mdx, content/tools/building-your-use-case-inventory/index.mdx
...
- Client-identifying [#client-identifying] — linked from content/process/build-the-workflows/index.mdx, content/process/sort-your-data/index.mdx, content/process/vet-and-choose-tools/index.mdx, content/tools/building-your-use-case-inventory/index.mdx
...
- Shadow IT [#shadow-it] — linked from content/domains/operations-and-back-office/index.mdx, content/tools/building-your-use-case-inventory/index.mdx
- State-registered adviser [#state-registered-adviser] — linked from content/domains/client-communication-and-marketing/index.mdx, content/domains/compliance-and-supervision/index.mdx, content/domains/data-privacy-and-security/index.mdx, content/domains/records-and-documentation/index.mdx, content/introduction/index.mdx, content/process/map-the-rules-that-apply/index.mdx, content/process/sort-your-data/index.mdx, content/tools/building-your-use-case-inventory/index.mdx, content/tools/this-years-figures/index.mdx
