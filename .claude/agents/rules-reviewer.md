...
4. **No disclaimer** on the page — "Hard rules" 4 and "Worksheet page (tools)".
...
11. **Internal links** use slugs that exist under `content/` — "Page templates" conventions.
